...
##   $ docker build -t ruby-for-mattlk13-github-updater .
##
## RUNNING
##   $ docker run -p 3000:3000 ruby-for-mattlk13-github-updater
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="8yls1pj" \
    STACKSMITH_STACK_NAME="Ruby for Mattlk13/github-updater" \
